...
function __promptline {
  ...
  local c_bg="${wrap}48;5;159${end_wrap}"
  local c_sep_fg="${wrap}38;5;159${end_wrap}"
  local warn_fg="${wrap}38;5;232${end_wrap}"
  local warn_bg="${wrap}48;5;166${end_wrap}"
  local warn_sep_fg="${wrap}38;5;166${end_wrap}"
  local y_fg="${wrap}38;5;18${end_wrap}"
  local y_bg="${wrap}48;5;45${end_wrap}"
  local y_sep_fg="${wrap}38;5;45${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
